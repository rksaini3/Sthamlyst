...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-6 py-16 bg-white dark:bg-[#0B0C1A] text-stone-900 dark:text-stone-100">
      ...
      <p className="text-stone-500 dark:text-stone-400 mb-8">Track and fix your brand's AI visibility</p>

      <button
        onClick={handleGoogleLogin}
        className="w-full max-w-md border border-stone-300 dark:border-stone-700 rounded-xl py-3 font-semibold flex items-center justify-center gap-2 mb-6"
      >
      ...
      <button
        ...
        className="mt-4 text-sm text-stone-500 dark:text-stone-400 underline"
      >
