...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-6 py-16 bg-white">
      ...
      <p className="text-gray-500 mb-8">Track and fix your brand's AI visibility</p>

      <button
        onClick={handleGoogleLogin}
        className="w-full max-w-md border rounded-lg py-3 font-semibold flex items-center justify-center gap-2 mb-6"
      >
